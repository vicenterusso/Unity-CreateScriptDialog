...
public class NewScriptWindow : EditorWindow
{
    ...
    //private const string kNamespaceMonoBehaviourName = "MonoBehaviour /w Namespace";
	...
	{
		GetWindow<NewScriptWindow> ("Create Script");
	}
    ...
    private void NamespaceSelectionGUI()
    {
        m_ScriptPrescription.m_NamespaceName = EditorGUILayout.TextField("Namespace", m_ScriptPrescription.m_NamespaceName);
